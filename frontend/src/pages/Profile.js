...
const Profile = () => {
  ...
  const [displayName, setDisplayName] = useState(() => localStorage.getItem('displayName') || 'General Services Department');
  const [email, setEmail] = useState(() => localStorage.getItem('email') || 'mseufgsd@gmail.com');
